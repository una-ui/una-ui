...
const global = ['resize', 'size', 'btn', 'breadcrumb-active', 'breadcrumb-inactive', 'calendar-today', 'calendar-selected', 'calendar-unselected', 'calendar-unavailable', 'calendar-outside']
