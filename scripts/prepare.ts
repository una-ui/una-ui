...
const global = ['resize', 'size', 'rounded', 'square', 'btn', 'breadcrumb-active', 'breadcrumb-inactive', 'pagination-unselected', 'pagination-selected', 'pagination-ellipsis', 'data-animate']
