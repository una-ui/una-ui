  ...
  <div grid="~ cols-1 lg:cols-5" class="my-15 gap-x-30 gap-y-5 lg:my-30 md:my-20 sm:my-15">
    ...
    <div col="lg:span-3 span-1" class="flex flex-col items-center lg:items-start space-y-10 lg:px-0 sm:px-25">
      ...
      <div flex="~ col" class="text-center space-y-2 lg:text-left">
        ...
        <h2 class="text-4xl text-muted font-bold lg:text-6xl">
          The Atomic CSS Framework
        </h2>
        <p class="pt-5 text-xl text-muted md:text-2xl">
          Unlock fast, modern, and lightweight web applications with Una UI, powered by Unocss Engine, optimized for Vue and Nuxt.
        </p>
      </div>
