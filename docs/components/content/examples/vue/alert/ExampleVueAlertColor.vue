...
<template>
  <div flex="~ col" space-y-4>
    ...
    <NAlert alert="outline-success" title="Success color" :description="description" />

    <NAlert alert="outline-warning" title="Warning color" :description="description" />

    <NAlert alert="outline-error" title="Error color" :description="description" />

    <NAlert alert="soft-purple" title="Purple color" :description="description" />

    <NAlert alert="soft-lime" title="Lime color" :description="description" />

    <NAlert alert="soft-orange" title="Orange color" :description="description" />

    <NAlert alert="soft-sky" title="Sky color" :description="description" />
  </div>
</template>
