...
> The example below uses `delay` prop to simulate a slow network connection, you can see in the [props](#props) section how to use it.
...
| `label`     | The label of the avatar.         |
| `icon`      | The icon of the avatar.          |

##### Example 2

::alert{type="info"}
You don't have to use this case, this is just an example of how you can use the `default` slot to have fallbacks if needed.
::
