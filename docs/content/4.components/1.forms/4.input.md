...
::alert{type="info"}
By default, the size of the input depends on the `font-size`. If you want to change the `font-size` and `padding` simultaneously, you can always customize it using utility classes.
::
