...
Below is an example of `NFormGroup` `NInput` `NButton` components with the same functionality as the HTML example above.
...
::alert{type="info"}
You can check the full documentation for the [Components here](/components).
::
