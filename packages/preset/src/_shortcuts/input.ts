...
export const staticInput: Record<`${InputPrefix}-${string}` | InputPrefix, string> = {
  ...
  // base
  'input': 'text-0.875em leading-6 px-0.8571428571428571em py-0.5em w-full input-disabled ring-ring ring-inset placeholder:text-$c-gray-400 block outline-none rounded-md border-0 shadow-sm bg-transparent',
  ...
  'input-outline-black': 'ring-1 focus:ring-foreground',
}
