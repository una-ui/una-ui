...
export const staticDropdownMenu: Record<`${DropdownMenuPrefix}-${string}` | DropdownMenuPrefix, string> = {
  ...
  // dropdown-menu-item
  'dropdown-menu-item': 'w-full justify-start font-normal text-left rounded-sm px-2 transition-color focus-visible:outline-0',
  ...
  'dropdown-menu-shortcut': 'ml-auto text-xs tracking-widest n-disabled space-x-0.5',

  // dropdown-menu-sub
  'dropdown-menu-sub': '',
  'dropdown-menu-sub-trigger': 'w-full justify-start font-normal rounded-sm px-2 transition-color focus-visible:outline-0',
