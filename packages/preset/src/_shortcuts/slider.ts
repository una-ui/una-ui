...
export const staticSlider: Record<`${SliderPrefix}-${string}` | SliderPrefix, string> = {
  ...
  'slider-thumb': 'w-1.25em h-1.25em block border-2 border-brand rounded-full bg-background focus-visible:ring-base ring-offset-base transition-colors disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2',
}
