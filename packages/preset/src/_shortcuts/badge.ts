...
export const staticBadge: Record<`${BadgePrefix}-${string}` | BadgePrefix, string> = {
  ...
  'badge-solid-black': 'bg-inverted text-background n-gray-300 dark:n-gray-600',
  'badge-outline-white': 'bg-base text-foreground ring-1 ring-base n-gray-600 dark:n-gray-300',
}
