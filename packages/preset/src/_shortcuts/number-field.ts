...
export const staticNumberField: Record<`${NumberFieldPrefix}-${string}`, string> = {
  ...
  'number-field-decrement': 'grid place-items-center absolute top-1/2 -translate-y-1/2 left-0 p-3 disabled:cursor-not-allowed disabled:opacity-20',
  ...
  'number-field-increment': 'grid place-items-center absolute top-1/2 -translate-y-1/2 right-0 disabled:cursor-not-allowed disabled:opacity-20 p-3',
}
