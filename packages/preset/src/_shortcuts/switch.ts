...
export const staticSwitch: Record<`${SwitchPrefix}-${string}` | SwitchPrefix, string> = {
  ...
  'switch-focus': 'focus-visible:ring-brand focus-visible:ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2',

  // thumb
  'switch-thumb': 'square-1em flex items-center justify-center absolute pointer-events-none block border border-border rounded-full bg-background shadow-lg ring-0 transition-transform',
