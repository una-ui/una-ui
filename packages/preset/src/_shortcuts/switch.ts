...
export const staticSwitch: Record<`${SwitchPrefix}-${string}` | SwitchPrefix, string> = {
  ...
  // thumb
  'switch-thumb': 'square-1em flex items-center justify-center absolute pointer-events-none block border border-base rounded-full bg-background shadow-lg ring-0 transition-transform',
