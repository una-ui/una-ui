...
export const staticButton: Record<`${ButtonPrefix}-${string}` | ButtonPrefix, string> = {
  ...
  // base
  'btn': 'bg-transparent size-sm leading-5 gap-1 btn-rectangle rounded-md inline-flex justify-center items-center btn-disabled font-semibold cursor-pointer',
  ...
  // variants
  'btn-solid-white': 'bg-base text-base ring-1 ring-base shadow-sm btn-focus hover:bg-muted',
  ...
  'btn-soft-gray': 'text-$c-gray-500 bg-$c-gray-50 ring-1 ring-$c-gray-50 btn-focus hover:bg-$c-gray-100',
  'btn-link-gray': 'text-$c-gray-500 btn-focus hover:text-$c-gray-950 hover:underline underline-offset-4',
  'btn-solid-black': 'bg-inverted text-inverted ring-1 ring-$c-gray-950 shadow-sm btn-focus hover:bg-$c-gray-800',
