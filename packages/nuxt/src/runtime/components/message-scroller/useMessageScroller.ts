...
import type {
  NMessageScrollerProviderProps,
  NMessageScrollerScrollable,
  NMessageScrollerScrollAlign,
  NMessageScrollerScrollOptions,
  NMessageScrollerVisibilityState,
} from '../../types'
...
interface PendingScrollToMessage {
  messageId: string
  options?: NMessageScrollerScrollOptions
}

function scrollableEqual(a: NMessageScrollerScrollable, b: NMessageScrollerScrollable) {
  return a.start === b.start && a.end === b.end
}

function visibilityEqual(
  a: NMessageScrollerVisibilityState,
  b: NMessageScrollerVisibilityState,
) {
  if (
...
export interface MessageScrollerContext {
  ...
  scrollable: Readonly<ShallowRef<NMessageScrollerScrollable>>
  scrollableAttr: ComputedRef<string | undefined>
  visibility: Readonly<ShallowRef<NMessageScrollerVisibilityState>>
  acquireVisibility: () => void
  releaseVisibility: () => void
  handleContentChange: () => void
  handleResize: () => void
  scrollToEnd: (options?: { behavior?: ScrollBehavior }) => boolean
  scrollToMessage: (messageId: string, options?: NMessageScrollerScrollOptions) => boolean
...
function createEngine(props: NMessageScrollerProviderProps) {
  ...
  const scrollable = shallowRef<NMessageScrollerScrollable>(EMPTY_SCROLLABLE)
  const visibility = shallowRef<NMessageScrollerVisibilityState>(EMPTY_VISIBILITY)
  ...
  function updateModeFromScroll(next: NMessageScrollerScrollable) {
...
export function provideMessageScroller(props: NMessageScrollerProviderProps) {
...
export function useMessageScrollerScrollable(): Ref<NMessageScrollerScrollable> {
  const { scrollable } = useMessageScrollerContext()
  return computed(() => scrollable.value)
}

export function useMessageScrollerVisibility(): Ref<NMessageScrollerVisibilityState> {
