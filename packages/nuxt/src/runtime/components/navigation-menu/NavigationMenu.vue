...
<template>
  ...
  >
    <NavigationMenuList
      ...
      :una="forwarded.una?.navigationMenuList"
      :orientation
    >
      <slot name="list" :items="items">
        ...
        >
          <NavigationMenuItem
            ...
            :value="item.value"
            :una="forwarded.una?.navigationMenuItem"
          >
            <slot :name="item.slot || 'item'" :item="item" :active="item.active">
              ...
              <NavigationMenuContent
                ...
                :una="forwarded.una?.navigationMenuContent"
              >
      ...
      <NavigationMenuIndicator
        v-if="indicator"
        :una="forwarded.una?.navigationMenuIndicator"
      />
    </NavigationMenuList>
  </NavigationMenuRoot>
</template>
